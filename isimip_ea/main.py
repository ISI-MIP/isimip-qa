...
def main():
    ...
    parser.add_argument(
        ...
        type=parse_list,
        default='global',
        help='Extract only specific regions (comma separated, automatically selected from --regions-locations)',
    )
    parser.add_argument(
        '-a',
        '--aggregations',
